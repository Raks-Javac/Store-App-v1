...
#To run  pytest store/tests/test_collections.py::TestCreateCollection
#  to skip @pytest.mark.skip
...
class TestCreateCollection:
    ...
    def test_if_user_is_not_admin_returns_401(self, authenticate_user, create_collection):
        authenticate_user(User(is_staff = False))
        response = create_collection({'title': 'a'})
